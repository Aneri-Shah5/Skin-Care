...
namespace Skincare {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public loginRow AddloginRow(string uname, string email, string password) {
...
namespace Skincare.DataSet1TableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[login] ([uname], [email], [password]) VALUES (@uname, @email, " +
                "@password)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[login] SET [uname] = @uname, [email] = @email, [password] = @passwo" +
                "rd WHERE (([loginid] = @Original_loginid))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT loginid, uname, email, password FROM dbo.login";
        ...
        public virtual int Insert(string uname, string email, string password) {
            if ((uname == null)) {
        ...
        public virtual int Update(string uname, string email, string password, int Original_loginid) {
            if ((uname == null)) {
